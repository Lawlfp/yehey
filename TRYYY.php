            ...
            <div class="margintop">
				<div class="fullbody">                      <div style="width:100%;height:72px;display:flex;flex-direction:row;">
															...
															<div class="patientcontainer">
																...
																<span style="font-family:Roboto;font-size:15px;font-weight:bold; margin-left:42px;margin-top:34px;margin-bottom:15px;">Personal Information</span><img src="info.png" class="smallicons" style="margin-top:34px;margin-left:8px;">
																
																<span style="font-family:Roboto;font-size:11px;font-weight:bold;color:#BEBBBB;margin-top:37px; margin-left:185px;">Edit</span>
																...
																<div class="flexcontainer"><span class="b">Patient Name</span><span><?php echo htmlspecialchars($patient['firstName']); ?> <?php echo htmlspecialchars($patient['middleName']); ?></span></div>
																<div class="flexcontainer"><span class="b">Patient ID</span><span>P-<?php echo htmlspecialchars($patient['id']); ?></span></div>
																<div class="flexcontainer"><span class="b">Sex</span><span><?php echo htmlspecialchars($patient['sex']); ?></span></div>
																<div class="flexcontainer"><span class="b">Birthdate</span><span><?php echo htmlspecialchars($patient['birthdate']); ?></span></div>
																<div class="flexcontainer"><span class="b">Email</span><span>christianjobtrio@gmail.com</span></div>	
																<div class="flexcontainer"><span class="b">Contact Number</span><span><?php echo htmlspecialchars($patient['contactNumber']); ?></span></div>
																<?php else: ?>
																<?php endif; ?>
															</div>
															</form>
															...
															<div class="patientcontainer2">
																...
																<span style="font-family:Roboto;font-size:11px;font-weight:bold;color:#BEBBBB;margin-top:37px; margin-left:135px;">Edit</span>
																</div>
																				<div class="flexcontainergrey" style="border-top: 0px;
																				  border-right: 0px;
																				  border-bottom: 1px solid #D3D3D3;
																				  border-left: 0px;padding-bottom:9px;"><span class="leftalign">Type</span><span>Date(ymd)</span>
																				  </div>
																		<div class="flexcontainernoline"><span class="align">Gingivitis</span><span>2023-08-11</span></div>		  
																		<div class="flexcontainernoline"><span class="align">Tooth Decay</span><span>2023-08-11</span></div>	
																		<div class="flexcontainernoline"><span class="align">Gingivitis</span><span>2023-08-11</span></div>		  
																		<div class="flexcontainernoline"><span class="align">Tooth Decay</span><span>2023-08-11</span></div>			  						
																		<div class="flexcontainernoline"><span class="align">Gingivitis</span><span>2023-08-11</span></div>		  
															...
															<div class="patientcontainer3">
																<div class="flexcontainer1">
																<span style="font-family:Roboto;font-size:15px;font-weight:bold; margin-left:33px;margin-top:34px;margin-bottom:15px;">Prescription History</span><img src="presc.png" class="smallicons" style="margin-top:34px;margin-left:8px;">
																<span style="font-family:Roboto;font-size:11px;font-weight:bold;color:#BEBBBB;margin-top:37px; margin-left:122px;">Edit</span>																																																		
																</div>
																
																					<div class="flexcontainergrey" style="border-top: 0px;
																				  border-right: 0px;
																				  border-bottom: 1px solid #D3D3D3;
																				  border-left: 0px;padding-bottom:9px;"><span class="leftalign">Name of Prescription</span><span>Date(ymd)</span>
																				  </div>
																		<div class="flexcontainernoline"><span class="align">Amoxicillin</span><span>2023-08-11</span></div>		  
																		<div class="flexcontainernoline"><span class="align">Celecoxib</span><span>2024-01-15</span></div>	
															</div>
																				<!-- TREATMENT HISTORY-->
															<div class="patientcontainer4">
																<div class="flexcontainer1">
																<span style="font-family:Roboto;font-size:15px;font-weight:bold; margin-left:33px;margin-top:34px;margin-bottom:15px;">Treatment History</span><img src="presc.png" class="smallicons" style="margin-top:34px;margin-left:8px;">
																<span style="font-family:Roboto;font-size:11px;font-weight:bold;color:#BEBBBB;margin-top:37px; margin-left:122px;">Edit</span>																																																		
																</div>
																				  ...
																				  border-right: 0px;
																				  border-bottom: 1px solid #D3D3D3;
																				  border-left: 0px;padding-bottom:9px;"><span class="leftalign">Name of Treatment</span><span>Date(ymd)</span>
																				  </div>
																		<div class="flexcontainernoline"><span class="align">Amoxicillin</span><span>2023-08-11</span></div>		  
																		<div class="flexcontainernoline"><span class="align">Celecoxib</span><span>2024-01-15</span></div>	
															</div>
															...
															<div class="patientcontainer5">
																...
																<span style="font-family:Roboto;font-size:20px;font-weight:bold; margin-left:33px;margin-top:34px;margin-bottom:15px;">Teeth History</span><img src="teeth.png" class="smallicons" style="margin-top:34px;margin-left:8px;">
																	...
																	<!-- <div class="align" style="margin-top:28px;border:#000000 2px solid;width:148px;height:33px;border-radius:10px;color:#000000;text-align:center;display:flex;flex-direction:row;align-items:center;justify-content:center;">
																		<span style="font-family:Roboto;font-size:12px;font-weight:bold;flex-grow: 1;">Dec-2002</span>
																		<div style="flex-shrink: 0; margin-left:-18px;">
																			<img src="dropdown.png" style="width:24px;height:24px;">
																		</div>
																	</div>
																	-->
